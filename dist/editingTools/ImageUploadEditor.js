...
var ImageUploadEditor = /*#__PURE__*/function (_React$Component) {
  _inheritsLoose(ImageUploadEditor, _React$Component);
  ...
  var _proto = ImageUploadEditor.prototype;
  ...
  _proto.render = function render() {
    ...
    var caption = content.caption,
        ...
        title = content.title;
    var previewImage = this.state.preview || DEFAULT_BACKGROUND_IMAGE;
    return /*#__PURE__*/_react["default"].createElement(_semanticUiReact.Container, {
      ...
      className: "loader"
    }, "loading...")) : this.state.preview ? 'Change image' : 'Select image', /*#__PURE__*/_react["default"].createElement("input", _extends({
      className: "hidden",
      hidden: true,
      type: "file",
      accept: "image/*",
    ...
    }, EditorProps.image)))), this.state.imageError && /*#__PURE__*/_react["default"].createElement("div", null, "Your file is too big. Please select a file less than " + parseInt(this.props.maxSize) / (1024 * 1024) + "MB.")), /*#__PURE__*/_react["default"].createElement(_semanticUiReact.Grid, {
      item: true,
      xs: 12
    ...
    }, EditorProps.anchor)), (showCaption || editCaption) && /*#__PURE__*/_react["default"].createElement(_semanticUiReact.Input, _extends({
      id: "image-caption",
      label: "Caption",
      value: caption,
